                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                             ...
                             <tr>
                               ...
                               <td><?php echo $c->companytitle;?></td>
                               <td><a href="<?php echo site_url("admin/CompanyC/searchcompany/$c->companyid"); ?>" style="color: black;" ><i class="zmdi zmdi-info"> </i>  more info</a></td>
                             </tr>
                             <?php
                             }
                             ?>                             
