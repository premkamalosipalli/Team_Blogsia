        ...
        <div class="row clearfix top-report">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
             ...
             <div class="card">
                    ...
                    <div class="body">
                        <form method=post action="<?php echo site_url("admin/TagsC/edittag/".$taginfo[0]->tagid);?>">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="email_address" class="form-control" name=tag value="<?php echo $taginfo[0]->tagname;?>">      
                                </div>
                                <br> <br>
                                <div class="form-line">
                                 ...
                                 <?php
                                    ...
                                    foreach ($subcat as $s) {
                                        if($taginfo[0]->subcatid==$s->subcatid)
                                        {
                                  ?>
