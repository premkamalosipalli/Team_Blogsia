        ...
        <div class="row clearfix top-report">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
             ...
             <div class="card">
                    ...
                    <div class="body">
                        <form method=post action="<?php echo site_url("admin/SubCatC/editsubcat/".$subcatinfo[0]->subcatid);?>">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="email_address" class="form-control" name=subcat value="<?php echo $subcatinfo[0]->subcatname;?>">      
                                </div>
                                <br> <br>
                                <div class="form-line">
                                 ...
                                 <?php
                                    ...
                                    foreach ($catinfo as $c) {
                                        if($subcatinfo[0]->categoryid==$c->categoryid)
                                        {
                                  ?>
