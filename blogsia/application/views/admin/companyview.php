...
<section class="content home">
    <div class="container-fluid" style="background-color:floralwhite;">
        ...
        <div class="row">
                ...
                <center>
                    <img src="<?php echo base_url("upload/company/").$cinfo[0]->logo; ?>" style="height: 150px; width: 150px; border:5px solid black; border-radius:100px">
                <br> 
                <p><h5 style="font-weight: bold;">Username: <?php echo $cinfo[0]->username;?> </h5></p>
                <p><h5 style="font-weight: bold;">Company-Title: <?php echo $cinfo[0]->companytitle;?> </h5></p>
                <p><h5 style="font-weight: bold;">Website: <?php echo $cinfo[0]->website;?> </h5></p>
                <p><h5 style="font-weight: bold;">Description: <?php echo $cinfo[0]->Description;?> </h5></p>
                </center>
                </div>
