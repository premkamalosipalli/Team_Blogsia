		...
		<div class="row">
			<div class="col col-lg-12 m-auto col-md-12 col-sm-12 col-12">
				<div class="main-header-content">
					<h1>Glimpse of Articles Saved By You</h1>
					<p>Welcome to your saved articles dashboard! Here you’ll find everything you have saved till date! Have fun!</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="ui-block">
					<article class="hentry post has-post-thumbnail thumb-full-width">
						...
						<center><h4><?php echo $a->articletitle?></h4>
							<img src="<?php echo base_url("upload/blogs/".$a->featuredimage)?>" style="height:80%;width:80%"  type="button" name="view" class="view_article" data-id="<?php echo $a->articleid?>">
						</center>
					</article>
				</div>
...
<script type="text/javascript">
	$(".view_article").click(function(){
		...
		$.ajax({
			url:"<?php echo site_url("user/SaveC/loadDataById/")?>"+articleid,
			method:"post",
