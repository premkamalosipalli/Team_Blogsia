...
! function(e) {
    ...
    e(".js-open-popup").on("click", (function(n) {
        ...
        27 == n.which && (l.removeClass("open"), o.removeClass("overlay-enable"), e(".profile-menu").removeClass("expanded-menu"), e(".popup-chat-responsive").removeClass("open-chat"), e(".profile-settings-responsive").removeClass("open"), e(".header-menu").removeClass("open"), e(".js-sidebar-open").removeClass("active"))
    })), t.on("click", (function(n) {
        e(n.target).closest(l).length || (l.removeClass("open"), o.removeClass("overlay-enable"), e(".profile-menu").removeClass("expanded-menu"), e(".header-menu").removeClass("open"), e(".profile-settings-responsive").removeClass("open"))
        ...
        return e(this).closest(l).removeClass("open"), o.removeClass("overlay-enable"), !1
